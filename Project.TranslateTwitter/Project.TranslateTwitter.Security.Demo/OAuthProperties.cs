...
namespace Project.TranslateTwitter.Security.Demo
{
	...
	{
		public static string AccessToken => Environment.GetEnvironmentVariable("Project_TranslateTwitter.AccessToken", EnvironmentVariableTarget.User);
		public static string AccessTokenSecret => Environment.GetEnvironmentVariable("Project_TranslateTwitter.AccessTokenSecret", EnvironmentVariableTarget.User);
